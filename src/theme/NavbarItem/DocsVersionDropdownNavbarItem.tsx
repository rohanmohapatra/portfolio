...
const getVersionMainDoc = (version: { docs: any[]; mainDocId: any }) =>
  version.docs.find((doc: { id: any }) => doc.id === version.mainDocId);
...
export default function DocsVersionDropdownNavbarItem({
  ...
  function getItems() {
    const versionLinks = versions.map((version: any) => {
