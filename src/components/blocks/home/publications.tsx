...
import { Stack, HStack, Heading, Grid, GridItem, StackProps, NativeSelect } from '@chakra-ui/react';
  ...
  return (
    <Stack gap="3rem" onClick={() => openUrl(link)}>
      ...
      <Stack align="center">
        ...
        <Heading code w="50%" size="xs" textAlign="center">
          {publicationName}
        </Heading>
      </Stack>
    </Stack>
      ...
      <Stack align="flex-start" w="full" gap="4rem">
        <Stack w="20rem">
          ...
          <NativeSelect.Root size="sm">
            <NativeSelect.Field value={filter} onChange={(e) => setFilter(e.currentTarget.value)}>
